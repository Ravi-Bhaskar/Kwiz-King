...
import com.raam.kwizking.SpinWheel.LuckyWheelView;
import com.raam.kwizking.SpinWheel.model.LuckyItem;
import com.raam.kwizking.databinding.ActivitySpinnerBinding;
    ...
    void updateCash(int index) {
            ...
            database.collection("users")
                ...
                public void onSuccess(Void unused) {
                    Toast.makeText(SpinnerActivity.this, "Coins Added in Wallet", Toast.LENGTH_SHORT).show();
                    finish();
                }
            });
    }
